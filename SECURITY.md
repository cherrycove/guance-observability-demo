...
- The EKS workshop overlay creates a public Gateway LoadBalancer with unauthenticated demo fault controls. Use it only on a disposable demo cluster and delete the LoadBalancer after the workshop.
...
- Generate unique MySQL passwords and store them only in Compose environment files or Kubernetes Secrets.
